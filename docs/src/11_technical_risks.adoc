...
|===
|Riesgo|Descripcion
| Bajo conocimiento de algunas herramientas y lenguajes| Algunos miebros del grupo nunca han trabajado o no tienen mucha experiencia con algunas de las herramientas o lenguajes utilizados para el desarrollo de la aplicación. Esto puede llevar a errores o retrasos debido a su falta de conocimiento.
