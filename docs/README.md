...
The deployment url is: [https://arquisoft.github.io/wichat_es6c/](https://arquisoft.github.io/wichat_es6c/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wichat_es6c/](https://arquisoft.github.io/wichat_es6c/), we need to execute `npm run deploy`.
